  ...
  return (
    <div className="bg-slate-950/70 border border-slate-800 hover:border-slate-700 rounded-xl p-4.5 space-y-3.5 transition-all shadow-sm flex flex-col justify-between group">
      <div className="space-y-3">
        {/* Header: Linked Claim Badge + Stance Pill */}
        <div className="flex flex-wrap items-center justify-between gap-2 pb-2.5 border-b border-slate-800/80">
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded bg-slate-900 border border-slate-700 text-cyan-400 font-mono font-bold text-[11px] flex items-center gap-1">
        ...
        <div className="bg-slate-900/60 border border-slate-800/90 rounded-lg p-3 space-y-1 relative">
          <Quote className="h-3.5 w-3.5 text-slate-600 mb-1" />
        ...
        {/* Stance Explanation (if provided by stance classifier) */}
        {evidence.stanceExplanation && (
          <div className="text-[11px] text-slate-400 font-mono italic px-1">
            Stance rationale: {evidence.stanceExplanation}
          </div>
        )}
      </div>
