...
const VERDICT_THEMES = {
  ...
  UNVERIFIED: {
    label: "UNVERIFIED",
    badgeBg: "bg-stone-900 text-[#94A3B8] border-stone-700",
    icon: HelpCircle,
...
export const InvestigationComparison: React.FC<InvestigationComparisonProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="bg-[#11141A] border border-stone-800 rounded-2xl w-full max-w-5xl max-h-[92vh] flex flex-col shadow-2xl relative overflow-hidden"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        {/* Modal Header */}
        <div className="flex items-center justify-between p-5 border-b border-stone-800 bg-[#0B0D11]/90">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-[#161B24] border border-stone-800 text-red-400">
              <ArrowRightLeft className="h-5 w-5" />
            </div>
            <div>
              <h2 className="text-base sm:text-lg font-bold text-[#F8F9FA] tracking-wide">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={onSwap}
              className="px-3 py-1.5 rounded-lg bg-[#161B24] hover:bg-[#1E2430] text-[#CBD5E1] border border-stone-700 text-xs font-sans flex items-center gap-1.5 transition-colors"
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 rounded-lg bg-[#161B24] hover:bg-[#1E2430] text-stone-400 hover:text-stone-200 border border-stone-800 transition-colors"
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6 flex-1 text-[#F8F9FA]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-xl bg-[#161B24] border border-stone-800 space-y-2">
          ...
          <div className="space-y-3">
            ...
            <div className="border border-stone-800 rounded-xl overflow-hidden bg-[#0B0D11]">
              <div className="grid grid-cols-12 text-xs font-mono font-bold text-[#F8F9FA] p-3 bg-[#161B24] border-b border-stone-800">
              ...
              {/* Row 1: Verdict */}
              <div className="grid grid-cols-12 text-xs font-mono p-3 border-b border-stone-900 items-center hover:bg-[#161B24]/40">
              ...
              <div className="grid grid-cols-12 text-xs font-mono p-3 border-b border-stone-900 items-center hover:bg-[#161B24]/40">
                <div className="col-span-4 sm:col-span-5 flex items-center gap-2 text-stone-300">
                  ...
                  <span>Media Match Candidates</span>
                </div>
                <div className="col-span-3 sm:col-span-2 text-center font-bold text-stone-200">
              ...
              <div className="grid grid-cols-12 text-xs font-mono p-3 items-center hover:bg-[#161B24]/40">
                <div className="col-span-4 sm:col-span-5 flex items-center gap-2 text-stone-300">
                  <XCircle className="h-4 w-4 text-red-400" />
                  <span>Contradicting Sources</span>
                </div>
                <div className="col-span-3 sm:col-span-2 text-center font-bold text-red-400">
                  {investigationA.contradictsCount}
                </div>
                <div className="col-span-2 text-center">
                  {renderDelta(metrics.contradictsDelta, "", true)}
                </div>
                <div className="col-span-3 text-center font-bold text-red-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-xl bg-[#161B24] border border-stone-800 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono text-[#F8F9FA] font-bold">
              ...
              <div className="space-y-2 text-xs font-mono">
                <div>
                  <div className="flex justify-between text-[11px] text-stone-400 mb-1">
                    ...
                    <span className="text-red-400 font-bold">{investigationA.confidenceScore}%</span>
                  </div>
                  <div className="w-full bg-[#0B0D11] rounded-full h-2 overflow-hidden border border-stone-800">
                    <div
                ...
                <div>
                  <div className="flex justify-between text-[11px] text-stone-400 mb-1">
                    ...
                    <span className="text-red-400 font-bold">{investigationB.confidenceScore}%</span>
                  </div>
                  <div className="w-full bg-[#0B0D11] rounded-full h-2 overflow-hidden border border-stone-800">
                    <div
                      className="h-full bg-gradient-to-r from-red-600 to-rose-400 rounded-full transition-all duration-500"
            ...
            <div className="p-4 rounded-xl bg-[#161B24] border border-stone-800 space-y-3">
              ...
              <div className="space-y-2 text-xs font-mono">
                ...
                <div>
                  ...
                  <div className="w-full bg-[#0B0D11] rounded-full h-2 overflow-hidden border border-stone-800 flex">
                    <div
        ...
        <div className="p-4 border-t border-stone-800 bg-[#0B0D11] flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-xs text-stone-500">
            Click to load either investigation directly into the active workbench
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              ...
              className="flex-1 sm:flex-none px-3 py-1.5 rounded-lg bg-[#161B24] hover:bg-[#1E2430] text-[#CBD5E1] border border-stone-700 text-xs font-sans flex items-center justify-center gap-1.5 transition-colors"
            >
